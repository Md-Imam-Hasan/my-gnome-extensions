...
export class SystemMonitorDropdown {
  ...
  _build() {
    ...
    this._uptimeItem = new M.PopupImageMenuItem(
      "",
    ...
    this._cpuItem = new M.PopupImageMenuItem(
      "",
    ...
    this._memItem = new M.PopupImageMenuItem(
      "",
      "drive-harddisk-solid-state-symbolic",
      {
        reactive: false,
        can_focus: false,
      },
    ...
    this._netDownItem = new M.PopupImageMenuItem(
      "",
    ...
    this._netUpItem = new M.PopupImageMenuItem(
      "",
    ...
    this._refreshItem.connect("activate", () => {
      try {
        ...
        console.error("[system-monitor@muhammad-imam-hasan.com] refresh", e);
      }
    });
  ...
  update(s) {
    ...
    this._setRow(
      this._netDownItem,
      "Download",
      s.netRxBps === null || s.netRxBps === undefined
        ? "N/A"
        : Format.formatSpeed(s.netRxBps),
    );
    this._setRow(
      this._netUpItem,
      "Upload",
      s.netTxBps === null || s.netTxBps === undefined
        ? "N/A"
        : Format.formatSpeed(s.netTxBps),
    );
  }
